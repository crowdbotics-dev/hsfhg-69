"""
Django settings for hsfhg_69 project.
...
WSGI_APPLICATION = "hsfhg_69.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hsfhg_69 API",
    "DESCRIPTION": "API documentation for hsfhg_69 App",
    "VERSION": "v1",
}
